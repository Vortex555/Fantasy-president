...
export const IDEOLOGIES = {
  Democrat: [
    ...
    { value: "Rural Democrat", axis: -0.28, sub: "+Farm country, +Gun owners, −Greens",
    ...
    { value: "Municipal Progressive", axis: -0.55, sub: "+Cities, +Labour, −Rural seats",
    ...
    { value: "Consumer Advocate", axis: -0.5, sub: "+Civil rights, −Big business hard",
    ...
    { value: "Veterans Democrat", axis: -0.3, sub: "+Pentagon, +Labour, culturally centrist",
    ...
    { value: "Public Health Democrat", axis: -0.48, sub: "+Health institutions, −Faith",
    ...
    { value: "Reform Liberal", axis: -0.38, sub: "+Institutions, anti-corruption",
    ...
    { value: "Abolitionist Left", axis: -0.88, sub: "+Civil rights hard, −Police, −Stability", fringe: true,
    ...
    { value: "Tenant Organiser", axis: -0.82, sub: "+Renters, +Labour, −Property", fringe: true,
    ...
    { value: "Marxist–Leninist", axis: -0.95, sub: "+Labour hard, −Everything else, −Stability hard", fringe: true,
    ...
    { value: "Anti-War Left", axis: -0.78, sub: "−Pentagon hard, +Civil rights", fringe: true,
  ...
  Republican: [
    ...
    // --- Added ---------------------------------------------------------------
    { value: "Suburban Republican", axis: 0.22, sub: "+Business, +Swing seats, −Base energy",
    ...
    { value: "Agrarian Conservative", axis: 0.42, sub: "+Farm country, +Faith, −Wall St",
    ...
    { value: "Defense Hawk", axis: 0.5, sub: "+Pentagon hard, −Deficit hawks",
    ...
    { value: "Energy Republican", axis: 0.48, sub: "+Fossil labour, +Business, −Greens hard",
    ...
    { value: "Reform Conservative", axis: 0.3, sub: "+Working families, −Wall St orthodoxy",
    ...
    { value: "Institutionalist", axis: 0.35, sub: "+Stability hard, −Populists",
     ...
     */
    { value: "Groyper", axis: 0.95, sub: "+Young online right hard, −Party establishment hard, −Civil rights hard", fringe: true,
      wrecker: true,
    ...
    { value: "Post-Liberal Integralist", axis: 0.88, sub: "+Faith hard, +State power, −Markets", fringe: true,
    ...
    { value: "Sovereigntist", axis: 0.86, sub: "+Gun owners hard, −Federal power, −Institutions", fringe: true,
    ...
    { value: "Techno-Monarchist", axis: 0.84, sub: "+Tech capital, −Democracy itself", fringe: true,
  ...
  Independent: [
    ...
    // --- Added ---------------------------------------------------------------
    { value: "Municipalist", axis: -0.5, sub: "+Cities, +Labour, anti-federal",
    ...
    { value: "Syncretic Populist", axis: 0.05, sub: "+Labour, +Faith, −Institutions",
    ...
    { value: "Pacifist", axis: -0.4, sub: "−Pentagon hard, +Civil rights",
    ...
    { value: "Frontier Libertarian", axis: 0.6, sub: "+Gun owners, −Federal power",
    ...
    { value: "Corporatist", axis: 0.25, sub: "+Business, +Labour, −Consumers",
    ...
    { value: "Technocratic Centrist", axis: 0.0, sub: "+Institutions hard, −Everyone else",
    ...
    { value: "Left Nationalist", axis: -0.65, sub: "+Labour hard, +Tariffs, −Globalists",
    ...
    { value: "Communitarian", axis: -0.15, sub: "+Faith, +Labour, −Individualists",
    ...
    { value: "Ethnonationalist", axis: 0.95, sub: "+Nativists hard, −Civil rights hard, −Stability hard", fringe: true,
    ...
    { value: "Climate Emergency", axis: -0.9, sub: "+Greens hard, −Industry, emergency powers", fringe: true,
    ...
    { value: "Populist Nationalist", axis: 0.7, sub: "+Labour, +Gun owners, −Institutions, −Trade", fringe: true,
    ...
    { value: "Crypto-Anarchist", axis: 0.55, sub: "+Tech capital, −State capacity hard", fringe: true,
    ...
    { value: "Localist Secessionist", axis: 0.4, sub: "−Federal power hard, +Local control", fringe: true,
    ...
    { value: "Technocratic Authoritarian", axis: 0.3, sub: "+Institutions hard, −Democracy", fringe: true,
